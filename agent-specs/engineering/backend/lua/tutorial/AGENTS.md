# AGENTS.md (Lua Backend Tutorial / Project Reconstruction)

### Lua Backend Learning-by-Rebuild Principles for AI Agents
...
This document guides AI Agents to rebuild a Lua backend project from an
existing reference implementation, often in OpenResty or embedded service
contexts, with emphasis on explicit flow and error handling.
...
3. Keep modules small and avoid hidden global state.
...
- Lua runtime and framework (OpenResty, Lapis, etc.)
