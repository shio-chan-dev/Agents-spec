# AGENTS.md (Rust Backend Tutorial / Project Reconstruction)

### Rust Backend Learning-by-Rebuild Principles for AI Agents
...
This document guides AI Agents to rebuild a Rust backend project from an
existing reference implementation, with emphasis on explicit types and
...
3. Keep modules small and ownership clear.
...
- Rust version and framework (axum, actix-web, etc.)
