# AGENTS.md (Go Backend Tutorial / Project Reconstruction)

### Go Backend Learning-by-Rebuild Principles for AI Agents
...
This document guides AI Agents to rebuild a Go backend project from an existing
reference implementation, with emphasis on explicit error handling and
...
2. Inventory the reference project (packages, services, data models).
...
3. Keep packages small and dependency direction clear.
...
- Go version and framework/router (if any)
